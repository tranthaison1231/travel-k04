...
export function Header() {
  const { toggleDropdown, DropdownMenu } = useDropdown([
    ...
    { label: "Create an account", link: "/Create an account" },
  ]);
  return (
    <div>
      ...
      <div className="flex items-center justify-between lg:px-20 lg:py-3 px-[20px] py-2 overflow-x-auto">
        <div className="flex items-center gap-5"> 
          ...
          <input
            placeholder="Search "
            className="hidden lg:block h-11 w-full text-base font-normal outline-none bg-[#E9E9E9] px-3 py-3 rounded-full"
          />
        </div>
        <nav className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-6">
            <div className="w-0.5 h-9 bg-[#101010] hidden lg:block"></div>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
              viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" 
              stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-search lg:hidden">
